 ...
 * @author ad15abk
 */
public class Players3Mode {
    
    JFrame table = new JFrame("Go Fish");
    JPanel handpanel;
    JButton deckbutton, gofishbutton, submitbutton, start, pick2, pick3, stopnplay;
    JTextField cardresponsetext;
    JLabel action, cardquestion, player1, player2, player3, 
            player2setcount, player3setcount, deckcount, playingcards,
    ...
    public Players3Mode() {
        ...
        pick3.setBounds(304, 750, 100, 50);
    ...
    public int RandomTurnStart(){
        ...
        while (match == false){
            randomplayer = rand.nextInt(game.player3.getId() + 1);
            if (randomplayer == 0){
                match = false;
            }
            else {
    ...
    public void GoFishButtonActionPerformed(ActionEvent evt) {  
        if (pilecount > 0){
            ...
            if(turn == game.player3.getId()){
                Timer res = new Timer(0, new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        action.setText(game.player1.getPlayername() + " said Go Fish !!!, and " + game.player3.getPlayername() + " picks up a card.");
                    }
                });
                res.start();
                res.setRepeats(false);
        ...
        if(match == false){
            ...
            if(game.player1.legalguess(userinput) == true){
                ...
                Timer asking = new Timer(0, new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        action.setText(game.player1.getPlayername() + " asked " + opponent.getPlayername() + " for any " + game.Asked() + "?");
    ...
    public void Pick2ButtonActionPerformed(ActionEvent evt){
        ...
        action.setText("Okay, " + game.player1.getPlayername() + " has picked " + game.player2.getPlayername() + " to ask for a card.");
    ...
    public void Pick3ButtonActionPerformed(ActionEvent evt){
        ...
        action.setText("Okay, " + game.player1.getPlayername() + " has picked " + game.player3.getPlayername() + " to ask for a card.");
        cardresponsetext.setEnabled(true);
        submitbutton.setEnabled(true);
        pick2.setEnabled(false);
        pick3.setEnabled(false);
                    ...
                    if(askedto == game.player1){
                        ...
                        if (pilecount > 0){
                            Timer option2 = new Timer(5000, new ActionListener() {
                                public void actionPerformed(ActionEvent e) {
                                     action.setText(askedto.getPlayername() + " said Go Fish !!!, and " + asking.getPlayername() + " picks up a card.");
                                }
                            });
                            option2.start();
        ...
        if(turn == game.player1.getId()){
            ...
            if (game.getTotalsetcount() != 13){
                if(game.player2.isdeckempty() != true){
                    ...
                    while (match == false){
                        ...
                        else if (playernum > game.player3.getId() || playernum == 0){
                    ...
                    Timer asking = new Timer(2000, new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                            action.setText("Okay, " + game.player2.getPlayername() + " has picked " + opponent.getPlayername() + " to ask for any " + game.Asked() + "?");
            ...
            if (game.getTotalsetcount() != 13){
                if(game.player3.isdeckempty() != true){
                    ...
                    Timer asking = new Timer(2000, new ActionListener() {
                        public void actionPerformed(ActionEvent e) {
                            action.setText("Okay, " + game.player3.getPlayername() + " has picked " + opponent.getPlayername() + " to ask for any " + game.Asked() + "?");
